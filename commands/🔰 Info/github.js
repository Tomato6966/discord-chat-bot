...
module.exports = {
	  ...
	  run: async (client, message, args, user, text, prefix) => {
        ...
        .addField("Source Code. ", "Don't just use the source for yourself,... please [invite](https://discord.com/api/oauth2/authorize?client_id=816624068358176788&permissions=8&scope=bot) me too![\`Click here\`](https://github.com/Tomato6966/discord-chat-bot/tree/main)")
        .setColor(ee.color)
